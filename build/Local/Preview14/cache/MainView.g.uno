public partial class MainView: Fuse.App
{
    ...
    [global::Uno.UX.UXGlobalResource("Sax")] public static readonly Fuse.Reactive.JavaScript Sax;
    ...
    static MainView()
    {
        Sax = new Fuse.Reactive.JavaScript(Uno.UX.NameTable.Empty);
        Sax.LineNumber = 5;
        Sax.FileName = "MainView.ux";
        global::Uno.UX.Resource.SetGlobalKey(Sax, "Sax");
        Sax.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../sax.js"));
    }
    public MainView()
    {
        InitializeUX();
