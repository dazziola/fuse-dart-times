public partial class MainView: Fuse.App
{
    ...
    [global::Uno.UX.UXGlobalResource("X2JS")] public static readonly Fuse.Reactive.JavaScript X2JS;
    ...
    static MainView()
    {
        X2JS = new Fuse.Reactive.JavaScript(Uno.UX.NameTable.Empty);
        X2JS.LineNumber = 5;
        X2JS.FileName = "MainView.ux";
        global::Uno.UX.Resource.SetGlobalKey(X2JS, "X2JS");
        X2JS.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../xml2json.js"));
    }
    public MainView()
    {
        InitializeUX();
